...
category.getSubCategory(id as string)
  ...
  <div class="sub-category">
    <div class="container">
      ...
      <XtxBread>
        ...
        <XtxBreadItem :to="`/category/${bread.top.id}`">{{ bread.top.name }}</XtxBreadItem>
      ...
      <div class="sub-filter">
        <div class="item">
          ...
          <div class="body">
            ...
            <a href="javascript:;" v-for="item in category.subCategory.brands" :key="item.id">
              {{ item.name }}
            </a>
          </div>
        </div>
